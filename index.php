...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      ...
      <p>La Dirección de Presupuesto y Evaluación de Gastos en Personal, lleva adelante el control y análisis de los gastos en materia de todo lo referente a gastos en personal de la Administración Central</p>
      </div>
    <div class="col-sm-4">
...
<div id="pricing" class="container-fluid">
  <div class="text-center">
    <h2>Autoridades</h2>
    <h4>Autoridades de la Dirección de Presupuesto y Evaluación de Gastos en Personal</h4>
  </div>
  <div class="row slideanim">
