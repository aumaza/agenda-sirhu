...
<div class="container-fluid text-center">    
  <div class="row content">
	...
	<button type="submit" class="btn btn-default btn-sm" name="C"><img class="img-reponsive img-rounded" src="../../icons/actions/user-group-properties.png" /> Usuarios</button>
	</form>
      </div> 
    </div>
